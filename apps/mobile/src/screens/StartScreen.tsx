...
const styles = StyleSheet.create({
  ...
  // "LIVE" badge — a soft warm chip, not a neon sticker.
  liveBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  // iOS-style segmented control — warmer, lower contrast.
  ...
  // Listen button — pill, warm, uses Claude orange when active.
  listenBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Hero title — serif display face. This is the app's "signature".
  appTitle: {
    color: colors.text,
    fontSize: 30,
  ...
  // Directive input — floating pill that reads as a single line.
  directiveRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: spacing.lg,
  ...
  // Speed chips — sit flush with the bottom, no loud borders.
  speedRow: {
    flexDirection: 'row',
    justifyContent: 'center',
    gap: spacing.xs + 2,
  ...
  // Ask / Stop bubbles — tinted glass pills.
  askAngelBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
